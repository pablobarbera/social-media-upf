...
This Rmarkdown script provides a description of some of the building blocks we will need to analyze social media data in this course. If you're having trouble following the guided coding part of the class, I recommend you run the following code and make sure you understand each of the concept introduced here.
