...
Before we start our coding session, let's become a bit more familiar with RStudio Server (which we will use to interact with R) and RMarkdown.
...
toInstall <- c("ROAuth", "streamR", "ggplot2", "stringr",
	"topicmodels", "devtools", "quanteda", "igraph", "httr", 
	"glmnet", "doMC")
